...
public class bucketCycleAuto extends StealthOpMode {
    ...
    static Pose scorePose = new Pose(18.15,125.85, Math.toRadians(135));
    static Pose grabBlock1Pose = new Pose(45.28,105.25, Math.toRadians(90));
    static Pose grabBlock2Pose = new Pose(45.28,113.61,Math.toRadians(90));
    static Pose grabBlock3Pose = new Pose(45.28,123.2, Math.toRadians(90));
