...
public class BucketCycleAuto extends StealthOpMode {
    ...
    private final Pose scorePose = new Pose(13.5,129, Math.toRadians(135));
    ...
    public void initialize() {
        ...
        block1ToBucket = follower.pathBuilder()
                ...
                .addParametricCallback(0.9, () -> follower.setMaxPower(0.6))
        ...
        block2ToBucket = follower.pathBuilder()
                ...
                .addParametricCallback(0.9, () -> follower.setMaxPower(0.5))
